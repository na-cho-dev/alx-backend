...
class Server:
    ...
    def get_hyper_index(self, index: int = None, page_size: int = 10) -> Dict:
        """Return a dictionary with pagination info that handles deletions."""
        ...
        # Collect 'page_size' items, skips missing indices if rows were deleted
        ...
        # Determine the next index for future pagination
